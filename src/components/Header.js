          ...
          <Navbar expand="lg" sticky="top" className="container">
              ...
              <Navbar.Collapse id="basic-navbar-nav">
                  ...
                  <Nav.Link as={NavLink} to="/login" className="signindiv">
                    <input type="submit" className="button signin-btn"  value="Admin Login"/></Nav.Link>
                  <Nav.Link as={NavLink} to="/employee" className="signindiv">
                    <input type="submit" className="button signin-btn"  value="Employee Login"/></Nav.Link>
                  </Nav>
              </Navbar.Collapse>
          </Navbar>
      </Router>
